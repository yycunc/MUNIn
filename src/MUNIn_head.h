...
public:
    ...
    double PvalueCalSP(vector< vector< vector<int> > > & zinput, vector<double> & a, int i, int j);

    //caculate the pvalue of the first tissue-specific peak
    double PvalueCalFstS(vector< vector< vector<int> > > & zinput, vector<double> & a, int i, int j);

    //caculate the pvalue of the second tissue-specific peak
    double PvalueCalSecS(vector< vector< vector<int> > > & zinput, vector<double> & a, int i, int j);
